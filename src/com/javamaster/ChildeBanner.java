...
public class ChildeBanner implements Banner {
    ...
    private static final String[] star4Promo = {"Diona","Ningguang","Beidou"};
    private static final String[] star4 = {"Sucrose","Chongyun","Noelle","Bennett","Fischl","Xingqiu","Xiangling","Amber","Razor","Kaeya","Barbara","Lisa",
